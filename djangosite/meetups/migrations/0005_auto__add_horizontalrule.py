...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('meetups_meetup_horizontalrule', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='horizontalrule_set', to=orm['meetups.Meetup'])),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('meetups', ['HorizontalRule'])


    def backwards(self, orm):
        # Deleting model 'HorizontalRule'
        db.delete_table('meetups_meetup_horizontalrule')
    ...
    models = {
        ...
        'meetups.horizontalrule': {
            'Meta': {'ordering': "['ordering']", 'object_name': 'HorizontalRule', 'db_table': "'meetups_meetup_horizontalrule'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'horizontalrule_set'", 'to': "orm['meetups.Meetup']"}),
