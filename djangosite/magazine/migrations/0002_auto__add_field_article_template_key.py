...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.template_key'
        db.add_column('magazine_article', 'template_key',
                      self.gf('django.db.models.fields.CharField')(default='base', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.template_key'
        db.delete_column('magazine_article', 'template_key')
